//
//  YVKVONotificationViewController.m
//  YVKnowledgeDemo
//
...
#import "YVKVONotificationViewController.h"

#import "YVKVOModel.h"

@interface YVKVONotificationViewController ()
...
@implementation YVKVONotificationViewController
...
//    self.kvoModel = [[YVKVOModel alloc]init];
...
- (void)setupLabel
{
    ...
    [_changeNum setTitle:@"增加1" forState:UIControlStateNormal];
...
{
    [YVKVOModel sharedKVOModel].num = [YVKVOModel sharedKVOModel].num+1;
}
